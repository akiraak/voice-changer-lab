...
| 項目 | 値 |
| --- | --- |
| 経路パターン | `<P1: シングル仮想ケーブル / P2: VoiceMeeter ハブ / P3: monitor 分離 / P4: BlackHole + Multi-Output / その他>`（[virtual-audio-devices.md §5](../../docs/specs/virtual-audio-devices.md#5-配信用途での典型構成)） |
